...
namespace Microsoft.Quantum.Documentation
{
    ...
    : SyntaxTreeTransformation
    {
        ...
        : base(TransformationOptions.Disabled)
        {
            ...
            this.Namespaces = new ProcessDocComments.DocCommentsNamespaceTransformation(this, outputPath);
        }
        ...
        private class DocCommentsNamespaceTransformation
        : NamespaceTransformation
        {
            private string? outputPath;
            internal DocCommentsNamespaceTransformation(ProcessDocComments parent, string? outputPath)
            : base(parent)
...
"
            ...
            public override QsCallable OnCallableDeclaration(QsCallable callable)
            {
                ...
                if (!callable.IsWithinCurrentCompilationUnit()) return callable;
